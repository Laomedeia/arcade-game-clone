...
/******/ 	var hotCurrentHash = "7239b47581ef91032c9d"; // eslint-disable-line no-unused-vars
...
/* WEBPACK VAR INJECTION */(function(global) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__js_engine_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__css_style_css__ = __webpack_require__(14);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_animate_css_animate_min_css__ = __webpack_require__(16);
...
//开始启动游戏
const MyEngine = Object(__WEBPACK_IMPORTED_MODULE_0__js_engine_js__["a" /* Engine */])(global);
...
let Engine = function (global) {
  ...
  function checkVictory() {
    if (Math.abs(__WEBPACK_IMPORTED_MODULE_1__app_js__["c" /* prize */].posX - __WEBPACK_IMPORTED_MODULE_1__app_js__["b" /* player */].posX) < 50 && Math.abs(__WEBPACK_IMPORTED_MODULE_1__app_js__["c" /* prize */].posY - __WEBPACK_IMPORTED_MODULE_1__app_js__["b" /* player */].posY) < 50) {
      console.log("You Win!!");
      stop();
  ...
  function resetPrizePos() {
    __WEBPACK_IMPORTED_MODULE_1__app_js__["c" /* prize */].posX = _.random(0, 404);
    __WEBPACK_IMPORTED_MODULE_1__app_js__["c" /* prize */].posY = _.random(60, 226);
  }
  ...
  function checkCollisions() {
    for (const enemy of __WEBPACK_IMPORTED_MODULE_1__app_js__["a" /* allEnemies */]) {
      //简单碰撞检测（enemyActImageWidth+playerActImageWidth）/ 2 = 85
      if (Math.abs(enemy.posX - __WEBPACK_IMPORTED_MODULE_1__app_js__["b" /* player */].posX) < 85 && Math.abs(enemy.posY - __WEBPACK_IMPORTED_MODULE_1__app_js__["b" /* player */].posY) < 75) {
        reset();
        break;
      }
    }
  ...
  function updateEntities(dt) {
    ...
    __WEBPACK_IMPORTED_MODULE_1__app_js__["a" /* allEnemies */].forEach(function (enemy) {
      enemy.update(dt, maxWidth);
    });
    __WEBPACK_IMPORTED_MODULE_1__app_js__["b" /* player */].update();
  }
  ...
  function render() {
    ...
    var rowImages = ["src/images/water-block.png", // 这一行是河。
    "src/images/stone-block.png", // 第一行石头
    "src/images/stone-block.png", // 第二行石头
    "src/images/stone-block.png", // 第三行石头
    "src/images/grass-block.png", // 第一行草地
    "src/images/grass-block.png" // 第二行草地
    ],
        numRows = 6,
        numCols = 5,
        row,
    ...
    for (row = 0; row < numRows; row++) {
      for (col = 0; col < numCols; col++) {
        /* 这个 canvas 上下文的 drawImage 函数需要三个参数，第一个是需要绘制的图片
               ...
               */
        ctx.drawImage(__WEBPACK_IMPORTED_MODULE_0__resources__["a" /* default */].get(rowImages[row]), col * 101, row * 83);
      }
    }
  ...
  function renderEntities() {
    ...
    __WEBPACK_IMPORTED_MODULE_1__app_js__["b" /* player */].render();
    __WEBPACK_IMPORTED_MODULE_1__app_js__["c" /* prize */].render();
  }
  ...
  function reset() {
    //玩家回归原始坐标
    __WEBPACK_IMPORTED_MODULE_1__app_js__["b" /* player */].posX = 202;
    __WEBPACK_IMPORTED_MODULE_1__app_js__["b" /* player */].posY = 392;
  }

  /* 紧接着我们来加载我们知道的需要来绘制我们游戏关卡的图片。然后把 init 方法设置为回调函数。
   * 那么党这些图片都已经加载完毕的时候游戏就会开始。
   */
  __WEBPACK_IMPORTED_MODULE_0__resources__["a" /* default */].load(["src/images/stone-block.png", "src/images/water-block.png", "src/images/grass-block.png", "src/images/enemy-bug.png", "src/images/char-boy.png", "src/images/Star.png"]);
  __WEBPACK_IMPORTED_MODULE_0__resources__["a" /* default */].onReady(init);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return allEnemies; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return player; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return prize; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Enemy_js__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Player_js__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Prize_js__ = __webpack_require__(11);
...
//构建虫子大军
__WEBPACK_IMPORTED_MODULE_3_lodash___default.a.times(3, function (n) {
  //赛道1，2，3
  let addY = n * 83;
  __WEBPACK_IMPORTED_MODULE_3_lodash___default.a.times(2, function (n) {
    let speedX = __WEBPACK_IMPORTED_MODULE_3_lodash___default.a.random(20, 200);
    const enemy = new __WEBPACK_IMPORTED_MODULE_0__Enemy_js__["a" /* default */](0, 60 + addY, speedX);
    allEnemies.push(enemy);
  });
});

//创建一个玩家
const player = new __WEBPACK_IMPORTED_MODULE_1__Player_js__["a" /* default */](202, 392);

//设置一个奖品
const prize = new __WEBPACK_IMPORTED_MODULE_2__Prize_js__["a" /* default */](__WEBPACK_IMPORTED_MODULE_3_lodash___default.a.random(0, 404), __WEBPACK_IMPORTED_MODULE_3_lodash___default.a.random(60, 226));
...
class Enemy {
   ...
   */
  render() {
    ctx.drawImage(__WEBPACK_IMPORTED_MODULE_0__resources_js__["a" /* default */].get(this.sprite), this.posX, this.posY);
  }
}
